...
namespace Day4EF
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            using (var db = new OrderContext())
            {
                while (true)
                {
                    ...
                    Console.WriteLine("2) Choose an Item");
        ...
        private static void CreateOrderItem(OrderContext db)
        {
            ...
            {
                Console.WriteLine($"{order.Id} - {order.Customer.Name} ");  // 11:51 huge hint for homework
        ...
        private static void CreateOrder(OrderContext db)
        {
            ...
            var customerId = int.Parse(Read("Customer ID? "));
        ...
        private static void CreateInventory(OrderContext db)
        {
            ...
            var name = Read("Product? ");
            var price = double.Parse(Read("Price? "));
            var qty = int.Parse(Read("QTY? "));
